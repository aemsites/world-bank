...
function addAttributes(span) {
  const iconName = Array.from(span.classList)
    ...
    .substring(5);
  const iconsvgs = {
    facebook: `<svg width="10" height="20" aria-label="facebook-icon" viewBox="0 0 10 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
    whatsapp: `<svg width="20" height="21" aria-label="whatsapp-icon" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
    twitter: `<svg width="15" height="16" aria-label="twitter-icon" viewBox="0 0 15 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
    linkedin: `<svg width="16" height="16" aria-label="linkedin-icon" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
    youtube: `<svg width="19" height="14" aria-label="youtube-icon" viewBox="0 0 19 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,
    flickr: `<svg width="20" height="10" aria-label="flickr-icon" viewBox="0 0 20 10" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4.42829 0.788574C1.98252 0.788574 0 2.7711 0 5.21687C0 7.66264 1.98252 9.64516 4.42829 9.64516C6.87406 9.64516 8.85659 7.66264 8.85659 5.21687C8.85659 2.7711 6.87406 0.788574 4.42829 0.788574ZM15.5711 0.788574C13.1254 0.788574 11.1428 2.7711 11.1428 5.21687C11.1428 7.66264 13.1254 9.64516 15.5711 9.64516C18.0169 9.64516 19.9994 7.66264 19.9994 5.21687C19.9994 2.7711 18.0169 0.788574 15.5711 0.788574Z" fill="white"/>
</svg>
`,
    instagram: `<svg width="17" aria-label="instagram-icon" height="19" viewBox="0 0 17 19" fill="none" xmlns="http://www.w3.org/2000/svg">
